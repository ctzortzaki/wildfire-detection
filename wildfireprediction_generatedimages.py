# -*- coding: utf-8 -*-
"""wildfirePrediction-generatedImages.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kHKofv-JnJpx4eV-oRJizzRf3Hig-F2Z
"""
...
original_train_data = datasets.ImageFolder(os.path.join(train_dir, "train"), transform=transform_train)
generated_data_dir = '/content/drive/MyDrive/generated_images'
generated_data = datasets.ImageFolder(generated_data_dir, transform=transform_train)

print(original_train_data.class_to_idx)
print(generated_data.class_to_idx)

assert original_train_data.class_to_idx == generated_data.class_to_idx, \
    "Mismatch in class names or order between datasets"

train_data = ConcatDataset([original_train_data, generated_data])
...
class_names = original_train_data.classes
...
def build_model_from_scratch():
    ...
    model.fc = nn.Sequential(
        nn.Linear(in_feats, 512),       # project 512→512-dim bottleneck
